  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <span className="text-white">Why DSA??</span>
        </div>
      </div>
      <motion.div
        style={{
      ...
      >
        <div className="absolute inset-0 bg-[#272729] text-white rounded-lg flex-col flex-center">
          <h1 className="text-3xl">Why Study DSA ??</h1>

          <p className="text-sm text-gray-200 px-4 py-5 text-center">
            Studying Data Structures and Algorithms (DSA) is important because
            it teaches how to solve problems effectively in coding. DSA helps
            manage data well, making software faster and better. By learning
            DSA, you can write smarter code, use resources wisely, and solve
            tricky problems easily. Understanding DSA not only improves coding
            skills but also helps think logically, which is useful in many
            fields like software development, data analysis, and AI.
          </p>
        </div>
      </motion.div>
    </div>
